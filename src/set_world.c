...
t_world	set_world(void)
{
	...
	t_color	red = construct_vec(0.9, 0.4, 0.4);
	t_color	green = construct_vec(0.4, 0.9, 0.4);
	// t_color	blue = construct_vec(0.4, 0.4, 0.9);

	
	// floor
	t_plane		*floor = gen_plane(construct_vec(0, 0, 0), construct_vec(0, 1, 0), gen_lambertian(gen_solid_texture(white)));
	...
	// light
	t_sphere	*light = gen_sphere(construct_vec(0, 10, -10), 1, gen_light(construct_vec(50, 50, 50)));
