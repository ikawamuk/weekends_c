...
t_world	set_world(void)
{
	...
	t_sphere	*sphereE = gen_sphere(construct_vec(-3, 4, -12), 4, gen_lambertian(gen_solid_texture(construct_color(0.2, 0.2, 0.6))));

	// light
	t_sphere	*lightA = gen_sphere(construct_vec(-4, 9, -9), 0.5, gen_light(bright));
