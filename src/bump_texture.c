...
static t_color	texture_value_bump(void *s, double u, double v, t_hit_record *rec)
{
	...
	t_vec3 local_normal = add_vec(scal_mul_vec(onb[0], -du * 0.05), add_vec(scal_mul_vec(onb[1], -dv * 0.05), scal_mul_vec(onb[2], 5)));
...
// {
// 	(void)v;
// 	return sin(20.0 * M_PI * u);
// }

// static double	height_2d_sin(double u, double v)
// {
// 	return sin(30.0 * M_PI * u) * sin(20.0 * M_PI * v);
// }

// static double	height_random(double u, double v)
// {
// 	double x = u * 12.9898 + v * 78.233;
// 	return (fmod(sin(x) * 43758.5453, 1.0));
// }
